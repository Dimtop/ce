...
export default function AdminVariableFiles(props){
                                ...
                                >
                                {
                                        ...
                                        <Pane width="20rem" display="flex" flexDirection="column" justifyContent="center" alignItems="center" textAlign="center" justifyItems="center">
                                            <Pane width="100%" marginBottom="2rem">
                                                ...
                                                <Button intent="info" width="20rem" marginTop="1rem" onClick={()=>{
                                                    window.open("/admin/machines/" + machine._id + "/files/variableFiles/"+fID+"/declarationOfCompliance","_blank")
                                    ...
                                    <Pane width="20rem" display="flex" flexDirection="column" justifyContent="center" alignItems="center" textAlign="center" justifyItems="center">
                                        <Pane width="100%" marginBottom="2rem">
                                            ...
                                            <Button intent="info" width="20rem" marginTop="1rem" onClick={()=>{
                                                 window.open("/admin/machines/" + machine._id + "/files/variableFiles/"+fID+"/production","_blank")
                                            }}>Εκτύπωση αρχείου</Button>
                                        </Pane>
                                    ...
                                    <Pane width="20rem" display="flex" flexDirection="column" justifyContent="center" alignItems="center" textAlign="center" justifyItems="center">
                                        <Pane width="100%" marginBottom="2rem">
                                            ...
                                            <Button intent="info" width="20rem" marginTop="1rem" onClick={()=>{
                                                   window.open("/admin/machines/" + machine._id + "/files/variableFiles/"+fID+"/partsList","_blank")
                                            }}>Εκτύπωση αρχείου</Button>
                                        </Pane>
