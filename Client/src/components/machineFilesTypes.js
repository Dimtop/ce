        ...
        <div id="machinesContainer">
            ...
            >
                 <Card
                    ...
                    cursor="pointer"
                    hoverElevation={2}
                    onClick={()=>location.replace("/machines/" + machine._id + "/files/presetFiles")}
                    >
                ...
                <Card
                    ...
                    cursor="pointer"
                    hoverElevation={2}
                    onClick={()=>location.replace("/machines/" + machine._id + "/files/manualFiles")}
                    >
                ...
                <Card
                    ...
                    cursor="pointer"
                    hoverElevation={2}
                    onClick={()=>location.replace("/machines/" + machine._id + "/files/variableFiles")}
                    >
